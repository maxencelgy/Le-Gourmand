...
{{--                @include("larecipe::partials.logo")--}}
                ...
                <img src="/storage/logo.png" width="60px" alt="Logo"/>
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/maxencelgy/Le-Gourmand" target="__blank" type="black" class="mx-2 px-4">
