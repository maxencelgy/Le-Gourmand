    ...
    return (
        <nav
            ...
            <div className="container h-16 lg:h-20 flex items-center justify-between lg:py-5">
                ...
                {/* burger mobil */}
                <div className="-mr-2 bg-yellow-500 rounded-lg flex items-center justify-end lg:hidden">
                    <button
                        onClick={() =>
                        ...
                        className="inline-flex items-center justify-center p-2 text-white transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none"
                    >
                        <svg
                            className="h-6 w-6"
                            stroke="#2A0029"
            ...
            <div
                className={
                    ...
                    " lg:hidden bg-purple-500"
                }
            >
                <div className="space-y-1 pt-2 pb-3 bg-purple-500 ">
                    <ResponsiveNavLink
                        href={route("home")}
                    ...
                    <ResponsiveNavLink href="/#equipe">Notre équipe</ResponsiveNavLink>
                    <ResponsiveNavLink
                        href={route("service")}
                    ...
                    {auth.user ? (
                    <ResponsiveNavLink href={route("shopping-cart.index")} active={route().current("shopping-cart.index")}>
                        <div className="relative">
                            {auth.user.cartCount > 0 && (
                ...
                {auth.user && (
                    <div className="border-t border-gray-200 pt-4 pb-1 ">
                        <div className="px-4">
                            <Link href={route("my_account")} className="text-yellow-500">
                                {auth.user.name}
                            </Link>

                            <div>
                                <span className="font-text text-sm text-white">
                                    {auth.user.email}
                                </span>
                            </div>
                        </div>
